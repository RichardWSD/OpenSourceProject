...
(function (global, factory) {
	...
	var
		...
		//\xa0 is actually non-breaking space in Latin1 (ISO 8859-1), also chr(160)，不换行的空格代码，也就是我们所知的“nbsp”
		rtrim = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
	...
	jQuery.extend({
		...
		//a plain object, created by {} or constructed with new Object
		...
		globalEval: function (code) {
			...
			if (code) {
				...
				if (code.indexOf("use strict") === 1) {
					...
					script.text = code;
					document.head.appendChild(script).parentNode.removeChild(script); //加script节点进去之后就执行了脚本了
				} else {
